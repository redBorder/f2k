...
#define X_TEMPLATE_ENTITIES \
	...
	X(STANDARD_ENTERPRISE_ID, EXPORTING_PROCESS_ID, 144, DONT_QUOTE_OUTPUT, "EXPORTING_PROCESS_ID", "exporting_process_id", "exporting_process_id", "Exporting Process Identifier", print_number, PRODUCT_NAME)\
	X(STANDARD_ENTERPRISE_ID, PRODUCT_NAME, PRIVATE_ENTITY_ID, QUOTE_OUTPUT, "PRODUCT_NAME", "product_name", "product_name", "Product Name", print_product_name, NO_CHILDS)\
