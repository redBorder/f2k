...
#define X_TEMPLATE_ENTITIES \
	...
	X(CISCO_ENTERPRISE_ID, CLIENT_IP_BASED_ON_DIRECTION, PRIVATE_ENTITY_ID, QUOTE_OUTPUT, "CLIENT_IP_BASED_ON_DIRECTION", "client_ip", "clientIP", "Client IP address", print_ip_client_addr, C(CLIENT_IP_NET_BASED_ON_DIRECTION, CLIENT_IP_NET_NAME_BASED_ON_DIRECTION))\
	X(CISCO_ENTERPRISE_ID, CLIENT_IP_NET_BASED_ON_DIRECTION, PRIVATE_ENTITY_ID, QUOTE_OUTPUT, "CLIENT_IP_NET_BASED_ON_DIRECTION", "client_ip_net", "clientIP", "Client IP address", print_ip_client_addr_net, NO_CHILDS)\
	X(CISCO_ENTERPRISE_ID, CLIENT_IP_NET_NAME_BASED_ON_DIRECTION, PRIVATE_ENTITY_ID, QUOTE_OUTPUT, "CLIENT_IP_NET_NAME_BASED_ON_DIRECTION", "client_ip_net_name", "clientIP", "Client IP address", print_ip_client_addr_net_name, NO_CHILDS)\
	X(CISCO_ENTERPRISE_ID, TARGET_IP_BASED_ON_DIRECTION, PRIVATE_ENTITY_ID, QUOTE_OUTPUT, "TARGET_IP_BASED_ON_DIRECTION", "target_ip", "targetIP", "Target IP address", print_ip_target_addr, C(TARGET_IP_NET_BASED_ON_DIRECTION, TARGET_IP_NET_NAME_BASED_ON_DIRECTION))\
	X(CISCO_ENTERPRISE_ID, TARGET_IP_NET_BASED_ON_DIRECTION, PRIVATE_ENTITY_ID, QUOTE_OUTPUT, "TARGET_IP_NET_BASED_ON_DIRECTION", "target_ip_net", "targetIP", "Target IP address", print_ip_target_addr_net, NO_CHILDS)\
	X(CISCO_ENTERPRISE_ID, TARGET_IP_NET_NAME_BASED_ON_DIRECTION, PRIVATE_ENTITY_ID, QUOTE_OUTPUT, "TARGET_IP_NET_NAME_BASED_ON_DIRECTION", "target_ip_net_name", "targetIP", "Target IP address", print_ip_target_addr_net_name, NO_CHILDS)\
