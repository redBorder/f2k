...
#define X_CISCO_URL \
	...
	X(CISCO_ENTERPRISE_ID, CISCO_HTTP_HOST, PRIVATE_ENTITY_ID, QUOTE_OUTPUT, "HTTP_HOST", "http_host", "", "CISCO HTTP_HOST information.",print_http_host,C(CISCO_HTTP_HOST_L1, CISCO_HTTP_HOST_L2))\
	X(CISCO_ENTERPRISE_ID, CISCO_HTTP_HOST_L1, PRIVATE_ENTITY_ID, QUOTE_OUTPUT, "HTTP_HOST_L1", "http_host_l1", "", "CISCO HTTP_HOST level 1 domain information.",print_http_host_l1,NO_CHILDS)\
