...
#define X_TEMPLATE_ENTITIES \
	...
	X(CISCO_ENTERPRISE_ID, LAN_PORT, PRIVATE_ENTITY_ID, DONT_QUOTE_OUTPUT, "LAN_PORT_BASED_ON_DIRECTION", "lan_port", "lanPort", "LAN Port number", print_lan_port, NO_CHILDS)\
	X(CISCO_ENTERPRISE_ID, WAN_PORT, PRIVATE_ENTITY_ID, DONT_QUOTE_OUTPUT, "WAN_PORT_BASED_ON_DIRECTION", "wan_port", "wanPort", "WAN Port number", print_wan_port, NO_CHILDS)\
